    ...
    <div class="container" style="max-width:600px">
        ...
        <div class="card">
            ...
            <table style="width:100%;margin-top:1rem">
                ...
                <?php endif; ?>
                <tr>
                    <td style="padding:0.75rem 0;color:rgba(255,255,255,0.6)"><?= $__('paid') ?></td>
                    <td style="padding:0.75rem 0;text-align:right;font-weight:700;color:#22c55e;font-size:1.2rem">&euro;<?= number_format($booking['total_price'], 2, ',', '.') ?></td>
                </tr>
            </table>
        </div>
