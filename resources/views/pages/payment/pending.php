    ...
    <div class="container" style="max-width:600px">
        ...
        <div class="card">
            ...
            <table style="width:100%;margin-top:1rem">
                ...
                <tr>
                    ...
                    <td style="padding:0.75rem 0;text-align:right;font-weight:700;color:#f59e0b;font-size:1.2rem">&euro;<?= number_format($booking['total_price'], 2, ',', '.') ?></td>
                </tr>
            </table>
        </div>
        ...
        <div class="buttons-container" style="text-align:center;margin-top:2rem">
            <a href="/booking/<?= $booking['uuid'] ?>" class="btn">
                <i class="fas fa-eye"></i> <?= $__('view_booking_status') ?>
            </a>
        </div>

        <p style="text-align:center;color:rgba(255,255,255,0.5);margin-top:2rem;font-size:0.9rem">
            <i class="fas fa-info-circle"></i> <?= $__('email_confirmation_note') ?>
        </p>
    </div>
</div>
