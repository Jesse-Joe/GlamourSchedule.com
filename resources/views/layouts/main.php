        ...
        function updateThemeToggleText() {
            ...
            if (toggleText) {
                const themeTexts = {
                    ...
                    ru: { light: 'Светлый режим', dark: 'Тёмный режим' },
                    ja: { light: 'ライトモード', dark: 'ダークモード' },
                    ko: { light: '라이트 모드', dark: '다크 모드' },
                    zh: { light: '浅色模式', dark: '深色模式' },
                    ar: { light: 'الوضع الفاتح', dark: 'الوضع الداكن' },
                    tr: { light: 'Açık mod', dark: 'Koyu mod' },
                    pl: { light: 'Tryb jasny', dark: 'Tryb ciemny' },
                    sv: { light: 'Ljust läge', dark: 'Mörkt läge' },
                    no: { light: 'Lys modus', dark: 'Mørk modus' },
                    da: { light: 'Lys tilstand', dark: 'Mørk tilstand' },
                    fi: { light: 'Vaalea tila', dark: 'Tumma tila' },
                    el: { light: 'Φωτεινή λειτουργία', dark: 'Σκοτεινή λειτουργία' },
                    cs: { light: 'Světlý režim', dark: 'Tmavý režim' },
                    hu: { light: 'Világos mód', dark: 'Sötét mód' },
                    ro: { light: 'Mod luminos', dark: 'Mod întunecat' },
                    bg: { light: 'Светъл режим', dark: 'Тъмен режим' },
                    hr: { light: 'Svijetli način', dark: 'Tamni način' },
                    sk: { light: 'Svetlý režim', dark: 'Tmavý režim' },
                    sl: { light: 'Svetli način', dark: 'Temni način' },
                    et: { light: 'Hele režiim', dark: 'Tume režiim' },
                    lv: { light: 'Gaišais režīms', dark: 'Tumšais režīms' },
                    lt: { light: 'Šviesus režimas', dark: 'Tamsus režimas' },
                    uk: { light: 'Світлий режим', dark: 'Темний режим' },
                    hi: { light: 'लाइट मोड', dark: 'डार्क मोड' },
                    th: { light: 'โหมดสว่าง', dark: 'โหมดมืด' },
                    vi: { light: 'Chế độ sáng', dark: 'Chế độ tối' },
                    id: { light: 'Mode terang', dark: 'Mode gelap' },
                    ms: { light: 'Mod cerah', dark: 'Mod gelap' },
                    tl: { light: 'Light mode', dark: 'Dark mode' },
                    he: { light: 'מצב בהיר', dark: 'מצב כהה' },
                    fa: { light: 'حالت روشن', dark: 'حالت تاریک' },
                    sw: { light: 'Hali ya mwanga', dark: 'Hali ya giza' },
                    af: { light: 'Ligte modus', dark: 'Donker modus' }
                };
